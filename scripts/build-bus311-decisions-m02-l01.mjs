...
const slides = waccM13Deck.slides.map((item, index) => {
...
const notes = waccM13Deck.slides.map((item) => item.note);
const html = [
  '<!doctype html><html lang="en"><head>',
  '<meta charset="utf-8">',
  '<meta name="viewport" content="width=device-width,initial-scale=1">',
  '<meta name="description" content="BUS311 M13 cost of capital, WACC, and company valuation lesson with editable financial visuals, Excel models, and classroom activities.">',
  '<title>BUS311 · Firm Decisions M13 · ', esc(waccM13Deck.title), '</title>',

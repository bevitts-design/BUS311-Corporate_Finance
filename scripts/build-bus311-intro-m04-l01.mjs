...
const lessonDir = path.join(root, '01-INTRO', 'M04');
const output = path.join(lessonDir, 'bus311-intro-m04-l01-slides.html');
...
const slides = ratioM04Deck.slides.map((item, index) => {
...
const notes = ratioM04Deck.slides.map((item) => item.note);

const html = [
  '<!doctype html><html lang="en"><head><meta charset="utf-8">',
  '<meta name="viewport" content="width=device-width,initial-scale=1">',
  '<meta name="description" content="BUS311 M04 ratio analysis lesson with editable ratio-family, DuPont, peer-selection, IPO, AI-company, and recommendation visuals.">',
  '<title>BUS311 · M04 · ', esc(ratioM04Deck.title), '</title><link rel="icon" href="data:,">',

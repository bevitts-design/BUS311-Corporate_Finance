...
const lessonDir = path.join(root, '02-VALUATION', 'M06');
const output = path.join(lessonDir, 'bus311-valuation-m06-l01-slides.html');
...
const slides = bondsM06L01Deck.slides.map((item, index) => {
...
const notes = bondsM06L01Deck.slides.map((item) => item.note);
const html = [
  '<!doctype html><html lang="en"><head>',
  '<meta charset="utf-8">',
  '<meta name="viewport" content="width=device-width,initial-scale=1">',
  '<meta name="description" content="BUS311 M06 bond valuation lesson with editable cash-flow timelines, Excel-style PV and RATE models, yield sensitivity, duration, credit spread, and a Meridian financing decision.">',
  '<title>BUS311 · Valuation M06 · ', esc(bondsM06L01Deck.title), '</title>',
  '<link rel="icon" href="data:,">',
  '<link rel="preconnect" href="https://fonts.googleapis.com">',
  '<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>',
  '<link href="https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Geist:wght@300;400;500;600;700;800&family=JetBrains+Mono:wght@400;500;600;700&display=swap" rel="stylesheet">',

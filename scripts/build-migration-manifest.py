...
def lesson_for(path):
    ...
    rules = [
        ...
        (r"chapter 5|time value|valuation of cashflows", "valuation-m01-l01", "VALUATION/M01"),
        (r"chapter 6|valuing bonds|bond assignment", "valuation-m02-l01", "VALUATION/M02"),
        (r"chapter 7|valuing stocks|ipo|equity valuation", "valuation-m03-l01", "VALUATION/M03"),
        (r"chapter 8|net present value|npv assignment", "valuation-m04-l01", "VALUATION/M04"),
        (r"chapter 11|chapter 12|risk.return|calculating_beta", "decisions-m01-l01", "DECISIONS/M01"),
        (r"chapter 13|wacc", "decisions-m02-l01", "DECISIONS/M02"),
        (r"chapter 14|chapter 15|chapter 16|chapter 17|corporate decision|debt to equity|equityaccounts", "decisions-m03-l01", "DECISIONS/M03"),

...
const models = [
  ...
  { id: 'intro-m02-l01', sheet: 'Market Cap', title: 'Apple Market Capitalization', inputs: [['Share price', 225, '$/share'], ['Diluted shares', 15.2, 'billion']], formula: '=B4*B5', result: 'Equity value', decision: 'Reconcile price date, share count, and units before comparing firms.' },
  { id: 'intro-m03-l01', sheet: 'Statements', title: 'Microsoft Statement Bridge', inputs: [['Revenue', 1200, '$m'], ['Cost of goods sold', 520, '$m'], ['Operating expenses', 330, '$m'], ['Interest expense', 40, '$m'], ['Taxes', 65, '$m']], formula: '=B4-B5-B6-B7-B8', result: 'Net income', decision: 'Reconcile the result with retained earnings and operating cash flow.' },
  { id: 'intro-m04-l01', sheet: 'Ratio Analysis', title: 'Nike Return on Equity', inputs: [['Net income', 245, '$m'], ['Beginning equity', 1000, '$m'], ['Ending equity', 1100, '$m']], formula: '=B4/AVERAGE(B5:B6)', result: 'Return on equity', decision: 'Decompose ROE into margin, asset use, and leverage before judging performance.' },

...
const lessons = [
  ['FOUNDATIONS', 'M01', 'foundations-m01-l02', 'Financial Institutions, Markets, and Ethics'],
  ['FOUNDATIONS', 'M02', 'foundations-m02-l02', 'Ratio Analysis and Corporate Performance'],
  ['VALUATION', 'M02', 'valuation-m02-l01', 'Bond Valuation, Interest Rates, and YTM'],
  ['VALUATION', 'M03', 'valuation-m03-l01', 'Equity Valuation and IPO Analysis'],
  ['VALUATION', 'M04', 'valuation-m04-l01', 'Capital Budgeting and Project Selection'],
  ['DECISIONS', 'M02', 'decisions-m02-l01', 'Cost of Capital and WACC'],
  ['DECISIONS', 'M03', 'decisions-m03-l01', 'Capital Structure and Financing Decisions']
];

...
**Status:** Approved student release | **Source:** CAPSTONE/source/bus311-capstone.json | **Version:** 1.4.0 | **SHA-256:** bdaa827c3453fc007142ab0372172fd5e524a8e5b4557d345282841ebc664495
...
- **Timing:** Upload by Monday, Nov. 30, 2026 at 12:30 p.m. ET; the same file is used for the live presentation
...
### oral Board presentation to the class — 25 points

- **Mode:** Live in class
- **Format:** Individual presentation using the submitted PowerPoint; no second Stage 5 file is uploaded
...
### Upload versus live presentation

Upload exactly one editable PowerPoint company-analysis project file in Canvas by **Monday, Nov. 30, 2026 at 12:30 p.m. ET, when class begins**. Required filename: `BUS311_[LastName]_[Ticker]_CompanyAnalysis.pptx`. The oral Board presentation happens live to the class on the assigned date and is not a second uploaded file. Use up to 7 minutes for the decision briefing and up to 3 minutes for live questions; both are scored together in the single 25-point oral criterion.
...
- All company-specific research, evidence selection, analysis, modeling, writing, slides, oral presentation, and responses to live questions are individual work.
...
- Deliver an individual oral Board presentation to the class on the assigned date: up to seven minutes for the decision briefing and up to three minutes for live questions, all assessed together as one oral-presentation criterion.
...
- Upload exactly one final Stage 5 file in the designated Canvas assignment: the editable PowerPoint company-analysis project (.pptx). The oral Board presentation is delivered live to the class on the assigned date and is not a second uploaded file. The Excel model is collected earlier at Milestone 3.
- Approved documented absences use the next protected slot or instructor-scheduled make-up. The live oral Board presentation, including responses to questions, remains required. Unexcused absences follow the BUS311 late-work policy and still require a make-up oral presentation.
